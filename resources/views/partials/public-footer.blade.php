...
<footer class="public-footer">
    <div class="public-footer-wrap">
        <div class="public-footer-grid">
            ...
            <div class="public-footer-column"><strong>Product</strong><div class="public-footer-links"><a href="{{ route('home') }}#features">Features</a><a href="{{ route('resources.index') }}" wire:navigate.hover>Guides</a><a href="{{ route('resources.crypto-india') }}" wire:navigate.hover>Trading journal guide</a><a href="{{ route('founder') }}" wire:navigate.hover>Meet the founder</a><a href="{{ route('home') }}#faq">FAQ</a></div></div>
